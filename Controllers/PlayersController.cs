...
namespace WebAppPlayers.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Pid,Pname,Prole,Pteam")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Pid,Pname,Prole,Pteam")] Player player)
        {
            if (id != player.Pid)
            {
                return NotFound();
